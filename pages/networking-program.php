...
<body>
    ...
    <section class="program-details-section" id="about">
        <div class="program-details-container">
            <div class="program-details-text">
                <h2 class="section-title" style="text-align:left;">Networking Program</h2>
            ...
            <div class="program-details-image-wrapper">
                <img src="../assets/imgs/networking.jpg" alt="Library Image" class="program-details-image" />
            </div>
        </div>
    </section>
    <!-- End About Section -->
    ...
    <section class="section">
        <h2 class="section-title">Networking Team</h2>
